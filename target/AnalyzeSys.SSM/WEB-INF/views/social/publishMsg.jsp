			...
			<div class="container-fluid">
				...
				<div class="col-sm-9 col-sm-offset-3 col-md-7 col-md-offset-2 main">
					...
					<p>
						...
						<form role="form">
							<div>
								<label for="Message_title">标题(15字以内)</label>
								<input name="price" id= "Message_title" style="width:500px" type="text" class="form-control"
								placeholder="请输入标题" required="required" >
								<br/><br/>
								<textarea id = "Message_content" name="customermessage" style="width:1000px;" rows="5" warp="virtual" placeholder="正文"></textarea>
							</div>
							<br/><br/>
							<div class="btn-group pull-left" style="margin-left: 0px;">
								<button id="publish_Message" type="button" class="btn btn-default">
...
<script type="text/javascript" src="../../../js/systemScripts/publishMsg.js"></script>