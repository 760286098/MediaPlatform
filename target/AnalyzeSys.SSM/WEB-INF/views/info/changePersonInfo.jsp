...
<!--controller capture 1-->
					...
					<div class="form-group has-feedback">
						...
						<div class="input-group">
							...
							<input id="departmentName" class="form-control" name="shopname" placeholder="请重新输入所属部门" maxlength="45" type="text" required="">
						</div>
					...
					<div class="form-group has-feedback">
						...
						<div class="input-group">
							...
							<input id="studentNumber" class="form-control" name="address" placeholder="请重新输入学号" maxlength="45" type="text" required="">
						</div>
					</div>
					...
					<div class="form-group has-feedback">
						...
						<div class="input-group">
							...
							<input id="phoneNumber" class="form-control" name="phone" placeholder="请重新输入联系方式" maxlength="11" type="text" required="" oninput ="checkPhone();"
								   onkeypress="keyPress();"
					...
					<div class="form-group has-feedback">
						...
						<div class="input-group">
							...
							<input id="startYear" class="form-control" name="manager" placeholder="请重新输入入学年份" maxlength="45" type="text" required="" oninput="checkManager();">
						</div>
